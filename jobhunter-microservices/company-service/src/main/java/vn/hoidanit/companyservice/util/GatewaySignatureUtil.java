...
public class GatewaySignatureUtil {
    ...
    /**
     * Verify Gateway signature from request headers
     * @return true if signature is valid and from Gateway
     */
    public static boolean verifyGatewaySignature(
        ...
        try {
            ...
            if (expectedSignature == null || !expectedSignature.equals(signature)) {
                log.error("SECURITY: Invalid Gateway signature! Potential attack or bypass attempt!");
                return false;
            }
